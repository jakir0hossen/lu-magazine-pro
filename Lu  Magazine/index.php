...
<nav>
	...
	<div class="container">
<a href="#" target="_blank"><img src="_blank" alt="" width="350px" ></a><br><hr>
...
?>
  ...
  <i class="fa fa-plus"></i> Add event member
  </button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<h3 class="text-center">Lu Magazine</h3>
...
<input type="text" class="form-control" name="user_aadhar" maxlength="12" placeholder="Enter 12-digit ID no. ">
</div>
</div>
